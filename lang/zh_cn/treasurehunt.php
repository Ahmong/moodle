...
/**
 * Strings for component 'treasurehunt', language 'zh_cn', branch 'MOODLE_31_STABLE'
 *
...
$string['groups'] = '小组';
$string['historicalattempts'] = '{$a}的历史尝试';
...
$string['sendlotacioncontent'] = '这一行动是不能撤销的。';
$string['sendlotaciontitle'] = '您确定要发送这个位置吗?';

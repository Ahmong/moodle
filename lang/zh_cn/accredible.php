...
/**
 * Strings for component 'accredible', language 'zh_cn', branch 'MOODLE_31_STABLE'
 *
 * @package   accredible
...
$string['activitydescription'] = '本模块在Accredible上自动创建和更新一个证书组。任何已发布的证书和徽章都在这个组，并且它们的外观和资料可以在<a href="https://www.accredible.com/issuer/dashboard" target="_blank">控制面板</a>上更新。';
